...
# Date formatting
release_timestamp = release_timestamp.replace('Z', '')
date = datetime.fromisoformat(release_timestamp)
date_and_time = date.strftime("%d/%m/%Y, %H:%M")
date = date.strftime("%d-%m-%Y")
datestring = "Latest PHE data from ", date_and_time, " GMT."
